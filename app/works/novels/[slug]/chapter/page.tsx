import { getNovel, generateMetadata as genMeta, getNovelChapterContent } from "@/lib/content"
      ...
      <main className="min-h-screen bg-gray-950">
        <Reader
          ...
          breadcrumbItems={[
            ...
            { label: chapter.title, href: `/works/novels/${params.slug}?chapter=${chapterId}`, active: true },
          ]}
        />
      </main>
    )
