  ...
  useEffect(() => {
    ...
    const bottomNavs = [
      document.querySelector(
        '[class*="bottom-4 left-1/2 transform -translate-x-1/2 z-50"]'
      ),
    ...
    return (
      <div className="fixed left-0 top-0 bottom-0 w-16 bg-gray-900/90 backdrop-blur-sm border-r border-gray-800 flex flex-col items-center py-6 z-40">
        ...
        <div className="flex-1 flex flex-col items-center gap-6">
          {/* Navigation buttons */}
          <Link href={onPrevPage || "/loop"} prefetch>
            <Button
              // onClick={() => router.push(onPrevPage || "/loop")}
              variant="ghost"
              size="icon"
          ...
          <Link href={onNextPage || "/loop"} prefetch>
            <Button
              // onClick={() => router.push(onNextPage || "/loop")}
              variant="ghost"
              size="icon"
              className="text-white"
              disabled={!onNextPage}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      <ColorPicker
                        value={
                          theme === "custom" ? customBackgroundColor : "#FFFFFF"
                        }
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    onValueChange={(values) =>
                      handleTransparencyChange(values[0])
                    }
                    className="mt-2"
                  />
                </div>
              ...
              <div className="grid gap-4">
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.5}
                    onValueChange={(values) =>
                      handleLetterSpacingChange(values[0])
                    }
                    className="mt-2"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    step={0.1}
                    onValueChange={(values) =>
                      handleLineHeightChange(values[0])
                    }
                    className="mt-2"
                  />
                </div>
    ...
    <div className={cn("relative min-h-screen w-full", className)}>
      ...
      >
        ...
        <div
          ref={contentRef}
          className={cn(
            `prose prose-lg mx-auto transition-all pb-24 ${getProseStyles()} whitespace-pre-wrap`,
